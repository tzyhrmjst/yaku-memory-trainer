...
const yakus = [
...

  {
    ...
    han: 1,
    category: 'basic',
    description: '三元牌（白·发·中）或场风牌、自风牌的刻子/槓子，每个刻子计1番。',
    conditions: [
...

  {
    ...
    exampleTiles: ['1m', '2m', '3m', '4p', '5p', '6p', '2s', '3s', '4s', '6s', '7s', '8s', '4m', '5m'],
    winTile: '3m 或 6m',
...

  {
    ...
    skipTileQuestion: true  // 4槓子显示异常（需18张牌）
  },
